...
StartLayer.prototype.newBlock = function (i, j) {
    ...
    blockLabel.setPosition(cc.p(this.blockWidth / 2 - 60, this.blockHeight / 2 - 120));
...
StartLayer.prototype.onTouchesBegan = function (touches, event) {
    ...
    if (block) {
    	var blockRect = cc.rectCreate(block.getPosition(), [this.blockWidth, this.blockHeight]);
